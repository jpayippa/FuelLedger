...
3. Run the automated test suite (`pytest`, 176 tests as of this change) and add tests for any new behavior; also test your change manually against a real (or synthetic) receipt image where OCR is involved.
